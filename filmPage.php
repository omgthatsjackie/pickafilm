<?php
    ...
    $isLiked = false;
    $searchThisInCollection = mysqli_query($db, "SELECT * FROM `likes` WHERE `userid`='$userid' AND `contentid`='$film_id'");
...
<!--							<source srcset="./assets/images/joker.webp" type="image/webp">-->
          ...
          <div class="main__column2 column2">
            ...
            <div class="column2__inf inf">
              ...
              <span class="inf__label red">Возрастное ограничение пока недоступно</span>
              <p class="inf__date">
                              <?php
